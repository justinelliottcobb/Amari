use amari_core::{Rotor, Bivector, Vector};
...
mod rotor_tests {
    ...
    fn test_rotor_rotation_of_vector() {
        ...
        assert_relative_eq!(rotated.mv.vector_component(2), 0.0, epsilon = 1e-10); // e3 component
    }
    ...
    fn test_rotor_logarithm() {
        ...
        assert_relative_eq!(log_rotor.as_slice(), expected_bivector.as_slice(), epsilon = 1e-10);
    }
    ...
    fn test_rotor_power() {
        ...
        assert_relative_eq!(squared.as_slice(), manual_square.as_slice(), epsilon = 1e-10);
    }
}